...
const products = [
  // Laptops
  { name: "Laptop HP", price: "$650", img: "img/imghp.webp", category: "laptop", desc: "Rendimiento confiable para trabajo y estudio." },
  { name: "Laptop Dell", price: "$720", img: "img/laptopmodule-dell.avif", category: "laptop", desc: "Diseño robusto y gran autonomía." },
